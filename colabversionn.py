...
url="https://raw.githubusercontent.com/saitejmaddula/HumanActivityPrediction/master/finaldata2.csv"
data=pd.read_csv(url,names = ["Time", "Activity"])
#data=pd.read_csv(io.BytesIO(uploaded["finaldata2.csv"]), names = ["Time", "Activity"])
#data=pd.read_csv("finaldata2.csv", names = ["Time", "Activity"])
